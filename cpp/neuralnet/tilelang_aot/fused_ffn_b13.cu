...
extern "C" __global__ void fused_ffn_kernel(const half_t* __restrict__ gate_weights, const half_t* __restrict__ input_tensor, const half_t* __restrict__ linear_weights, half_t* __restrict__ output);
extern "C" __global__ void __launch_bounds__(128, 3) fused_ffn_kernel(const half_t* __restrict__ gate_weights, const half_t* __restrict__ input_tensor, const half_t* __restrict__ linear_weights, half_t* __restrict__ output) {
    ...
    tl::cp_async_commit();
    {
      ...
      for (int ki_1 = 0; ki_1 < 2; ++ki_1) {
        ...
        for (int i_12 = 0; i_12 < 4; ++i_12) {
          tl::ptx_ldmatrix_x4((&(((half_t*)input_shared)[(((((((ko & 1) * 4096) + (((((int)threadIdx.x) & 63) >> 5) * 2048)) + (i_12 * 512)) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + ki_1) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), (&(A_local_1[(i_12 * 8)])));
        }
        #pragma unroll
        for (int i_13 = 0; i_13 < 2; ++i_13) {
          tl::ptx_ldmatrix_x4_trans((&(((half_t*)gate_shared)[(((((ko & 1) * 2048) + (ki_1 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + i_13) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local_1[(i_13 * 8)])));
        }
        for (int i_14 = 0; i_14 < 4; ++i_14) {
          for (int j_1 = 0; j_1 < 2; ++j_1) {
            tl::mma_sync<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat16, 16, 8, 16, false, true>(reinterpret_cast<unsigned*>(gate_local + ((i_14 * 16) + (j_1 * 8))), reinterpret_cast<const unsigned*>(A_local_1 + (i_14 * 8)), reinterpret_cast<const unsigned*>(B_local_1 + (j_1 * 8)));
            tl::mma_sync<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat16, 16, 8, 16, false, true>(reinterpret_cast<unsigned*>(gate_local + (((i_14 * 16) + (j_1 * 8)) + 4)), reinterpret_cast<const unsigned*>(A_local_1 + (i_14 * 8)), reinterpret_cast<const unsigned*>(B_local_1 + ((j_1 * 8) + 4)));
          }
        }
      }
    }
  ...
  }
  {
    ...
    for (int ki_3 = 0; ki_3 < 2; ++ki_3) {
      ...
      for (int i_20 = 0; i_20 < 4; ++i_20) {
        tl::ptx_ldmatrix_x4((&(((half_t*)input_shared)[(((((((((int)threadIdx.x) & 63) >> 5) * 2048) + (i_20 * 512)) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + ki_3) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), (&(A_local_3[(i_20 * 8)])));
      }
      #pragma unroll
      for (int i_21 = 0; i_21 < 2; ++i_21) {
        tl::ptx_ldmatrix_x4_trans((&(((half_t*)gate_shared)[(((ki_3 * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + i_21) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local_3[(i_21 * 8)])));
      }
      for (int i_22 = 0; i_22 < 4; ++i_22) {
        for (int j_3 = 0; j_3 < 2; ++j_3) {
          tl::mma_sync<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat16, 16, 8, 16, false, true>(reinterpret_cast<unsigned*>(gate_local + ((i_22 * 16) + (j_3 * 8))), reinterpret_cast<const unsigned*>(A_local_3 + (i_22 * 8)), reinterpret_cast<const unsigned*>(B_local_3 + (j_3 * 8)));
          tl::mma_sync<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat16, 16, 8, 16, false, true>(reinterpret_cast<unsigned*>(gate_local + (((i_22 * 16) + (j_3 * 8)) + 4)), reinterpret_cast<const unsigned*>(A_local_3 + (i_22 * 8)), reinterpret_cast<const unsigned*>(B_local_3 + ((j_3 * 8) + 4)));
        }
      }
    }
  }
  ...
  }
  {
    ...
    for (int ki_5 = 0; ki_5 < 2; ++ki_5) {
      ...
      for (int i_26 = 0; i_26 < 4; ++i_26) {
        tl::ptx_ldmatrix_x4((&(((half_t*)input_shared)[((((((((((int)threadIdx.x) & 63) >> 5) * 2048) + (i_26 * 512)) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + ki_5) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8)) + 4096)])), (&(A_local_5[(i_26 * 8)])));
      }
      #pragma unroll
      for (int i_27 = 0; i_27 < 2; ++i_27) {
        tl::ptx_ldmatrix_x4_trans((&(((half_t*)gate_shared)[((((ki_5 * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + i_27) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 2048)])), (&(B_local_5[(i_27 * 8)])));
      }
      for (int i_28 = 0; i_28 < 4; ++i_28) {
        for (int j_5 = 0; j_5 < 2; ++j_5) {
          tl::mma_sync<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat16, 16, 8, 16, false, true>(reinterpret_cast<unsigned*>(gate_local + ((i_28 * 16) + (j_5 * 8))), reinterpret_cast<const unsigned*>(A_local_5 + (i_28 * 8)), reinterpret_cast<const unsigned*>(B_local_5 + (j_5 * 8)));
          tl::mma_sync<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat16, 16, 8, 16, false, true>(reinterpret_cast<unsigned*>(gate_local + (((i_28 * 16) + (j_5 * 8)) + 4)), reinterpret_cast<const unsigned*>(A_local_5 + (i_28 * 8)), reinterpret_cast<const unsigned*>(B_local_5 + ((j_5 * 8) + 4)));
        }
      }
    }
  }
...
void launchFusedFFNB13(
  ...
  dim3 grid(18, 37, 1);
  fused_ffn_kernel<<<grid, 128, 32768, stream>>>(
