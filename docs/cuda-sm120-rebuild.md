...
Status: stage 0 scaffold (2026-08-05)
...
starts bit-identical and each stage can land behind its config switch.
...
1. FA4 both16 attention: fixed B19/S361/H12/D32, noncausal, CuTe AOT; fall back to
   official attention for unsupported shapes/precision.
