...
KATAGO_PIP_EXTRA_INDEX_URLS="${KATAGO_PIP_EXTRA_INDEX_URLS:-https://pypi.nvidia.com https://download.pytorch.org/whl/cu132}"
KATAGO_PIP_CACHE_DIR="${KATAGO_PIP_CACHE_DIR:-${KATAGO_ENV_ROOT}/cache/pip}"
KATAGO_CUDA_ROOT=""
KATAGO_CUDNN_ROOT=""
...
export KATAGO_PIP_EXTRA_INDEX_URLS KATAGO_PIP_CACHE_DIR
...
configure_pip_environment() {
  mkdir -p -- "${KATAGO_PIP_CACHE_DIR}"
  export PIP_INDEX_URL="${KATAGO_PYPI_MIRROR}"
  export PIP_EXTRA_INDEX_URL="${KATAGO_PIP_EXTRA_INDEX_URLS}"
  export PIP_CACHE_DIR="${KATAGO_PIP_CACHE_DIR}"
}
