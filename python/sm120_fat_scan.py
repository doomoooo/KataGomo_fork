...
_FAMILY_ABI = {
    ...
    "linear2": {
        ...
        "launch_args": "const half*, const half*, half*, cudaStream_t",
        "entry_tail": "SM120_GPU_OTHER, 0, 1152",
    },
}
...
def render_registry(family: str, requests: Iterable[dict]) -> str:
    ...
    for item in values:
        ...
        entries.append(
            f'  {{{item["batch"]}, {abi["entry_tail"]}, {quoted_id}, false, '
            f'{item["launch_symbol"]}}}'
        )
    entry_text = ",\n".join(entries)
    return f'''// Generated by python/sm120_prepare_tilelang_fat_scan.py. Do not edit.
