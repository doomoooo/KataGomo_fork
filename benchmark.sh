...
CLEAR_TRT_CACHE="${CLEAR_TRT_CACHE:-0}"
TRT_BUILDER_OPT_LEVEL="${TRT_BUILDER_OPT_LEVEL:--1}"
TRT_AVG_TIMING_ITERS="${TRT_AVG_TIMING_ITERS:--1}"
TRT_MAX_AUX_STREAMS="${TRT_MAX_AUX_STREAMS:-8}"
TRT_SET_TACTIC_SOURCES="${TRT_SET_TACTIC_SOURCES:-true}"
TRT_MULTI_PROFILE="${TRT_MULTI_PROFILE:-true}"
NN_MAX_BATCHSIZE="${NN_MAX_BATCHSIZE:-4}"
NN_MIN_BATCHSIZE="${NN_MIN_BATCHSIZE:-4}"
NUM_SEARCH_THREADS="${NUM_SEARCH_THREADS:-16}"
TRT_CUDA_STREAMS="${TRT_CUDA_STREAMS:-4}"
TRT_DEVICE_ID="${TRT_DEVICE_ID:-0}"
BENCH_VISITS="${BENCH_VISITS:-100000}"
KATAGO_BIN="${KATAGO_BIN_PATH_OVERRIDE:-${KATAGO_BIN_PATH}}"
KATAGO_MODEL="${KATAGO_MODEL_PATH_OVERRIDE:-${KATAGO_MODEL_PATH}}"
KATAGO_CONFIG="${KATAGO_CONFIG_PATH_OVERRIDE:-${KATAGO_CONFIG_PATH}}"
